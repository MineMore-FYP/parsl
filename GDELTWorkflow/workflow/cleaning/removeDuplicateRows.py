...
df = pd.read_csv("/home/mpiuser/FYP/testcsv/test.csv", index_col = False)
...
dfNew.to_csv ("/home/mpiuser/FYP/testcsv/removeDuplicateRowsOUTPUT.csv", index = False, header=True)
